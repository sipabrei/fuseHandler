...
public class Handler2XMLProcessor implements Processor {	
	private static Logger logger = LogManager.getLogger("Handler2XMLProcessor");
	...
	public void process(Exchange exchange) throws Exception {
		...
		purchaseItems.addHandler2(item);
